...
config = {
    "max_disp": 192,
    "cost_aggregator_scale": 8,  # for DeepPruner-fast change this to 8.
    ...
    "feature_extractor_refinement_level_outplanes": 64,  # for DeepPruner-fast change this to 64.
    ...
    "post_CRP_sampler_type": "patch_match",  # change to patch_match for Sceneflow model.
